...
train_image_path = "path to MNIST train image data"
train_label_path = "path to MNIST train label data"
...
test_image_path = "path to MNIST test image data"
test_label_path = "path to MNIST test label data"
